...
function getVimeoCode(videoid) {
	return '<iframe src="http://player.vimeo.com/video/' + videoid + '?title=0&amp;byline=0&amp;color=bca88f" width="600" height="338" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
}
function getYoutubeCode(videoid) {
	return '<iframe width="600" height="338" src="http://www.youtube.com/embed/' + videoid + '?autoplay=1&rel=0" frameborder="0" allowfullscreen></iframe>';
}
